...
if(typeof require !== 'undefined') {
  ...
  try { _fastCsv = require('fast-csv'); } catch(e) {}
}
...
class CSV {
  ...
  write(stream, options) {
    return new Promise((resolve, reject) => {
      ...
      const csvStream = _fastCsv.format(options.formatterOptions);
      stream.on('finish', () => {
        resolve();
      });
  ...
  writeFile(filename, options) {
    ...
    const stream = _fs.createWriteStream(filename, streamOptions);
